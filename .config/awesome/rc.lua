...
-- {{{1 Tags
-- Define a tag table which hold all screen tags.
tags_name = { "1Firefox", "2Irc", "3Term", "4Emacs", "5Email", "6Pcmanfm", "7Vinagre", "8Tags", "9Music", '0Virtual' }
tags_layout = {
  awful.layout.suit.tile,
  awful.layout.suit.tile,
  awful.layout.suit.tile,
...
globalkeys = awful.util.table.join(
    ...
    --awful.key({ modkey, }, "a", function () awful.util.spawn("/opt/thunderbird/thunderbird") end),
    ...
    awful.key({ modkey, }, "x", function () awful.util.spawn("xterm -e ranger") end),
